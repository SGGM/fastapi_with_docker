...
def test_create_note(test_app, monkeypatch):
    test_request_payload = {"title": "smth", "description": "smth else"}
    test_response_payload = {"id": 1, "title": "smth", "description": "smth else"}
...
def test_create_note_invalid_json(test_app):
    response = test_app.post("/notes/", content=json.dumps({"title": "smth"}))
...
def test_read_note(test_app, monkeypatch):
    test_data = {"id": 1, "title": "smth", "description": "smth else"}
...
def test_read_all_notes(test_app, monkeypatch):
    test_data = [
        {"title": "smh", "description": "smh else", "id": 1},
